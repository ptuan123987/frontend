...
const CourseCard = ({ course }) => {
  ...
  const { paidCourses, fetchPaidCourse } = usePaidCourseStore(state => ({
  ...
  useEffect(() => {
    // Fetch thông tin khóa học đã thanh toán khi component được render lần đầu tiên
    fetchPaidCourse();
    setIsLoading(false); // Khi fetchPaidCourse hoàn thành, dừng loading
  }, []);

  // Hàm xử lý thêm hoặc xóa khóa học khỏi wishlist
