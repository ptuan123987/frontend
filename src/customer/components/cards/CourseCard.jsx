...
const CourseCard = ( {courseId} ) => {
  ...
  return (
    <div className="flex flex-col max-w-[15rem] relative group"
      ...
      {courseInfo && ( // Thêm điều kiện kiểm tra courseInfo
      <Link to={`/course/${courseId}`} className="my-5">
        <img
