...
const CartItem = ({ course, isSelected, onToggleItem }) => {
  const handleCartItemClick = () => {
    onToggleItem(course.id); // Gọi hàm onToggleItem khi người dùng click vào CartItem
  };
  ...
  return (
    <div
      ...
      onClick={handleCartItemClick} // Gọi handleCartItemClick khi người dùng click vào CartItem
    >
